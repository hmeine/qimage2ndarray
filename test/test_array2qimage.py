...
def test_gray2qimage():
    ...
    assert qImg.format() == QtGui.QImage.Format.Format_Indexed8
...
def test_scalar2qimage():
    ...
    assert qImg.width() == 320
    assert qImg.height() == 240
    assert qImg.format() == QtGui.QImage.Format.Format_RGB32
...
def test_scalar2qimage_with_alpha():
    ...
    assert qImg.width() == 320
    assert qImg.height() == 240
    assert qImg.format() == QtGui.QImage.Format.Format_ARGB32
