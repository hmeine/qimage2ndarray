...
# Format_RGB16 = 4
def test_raw_rgb16():
    qimg = QtGui.QImage(320, 240, QtGui.QImage.Format.Format_RGB16)
    qimg.fill(0)
    v = qimage2ndarray.raw_view(qimg)
    qimg.fill(23)
...
def test_raw_grayscale8():
    qimg = QtGui.QImage(320, 240, QtGui.QImage.Format.Format_Grayscale8)
    qimg.fill(0)
    v = qimage2ndarray.raw_view(qimg)
    qimg.fill(1)
...
def test_raw_rgba64():
    qimg = QtGui.QImage(320, 240, QtGui.QImage.Format.Format_RGBA64)
    qimg.fill(0)
    v = qimage2ndarray.raw_view(qimg)
    qimg.fill(1)
